...
#There's actually some cities on there that are in duplicate, and other's that aren't cities because of the maps containing links that are on the wikipedia page: need to be fixed (http://en.wikipedia.org/wiki/List_of_cities_and_municipalities_in_the_Philippines)
citiesOrMunici = {
'Abra': [
'Bangued',
'Boliney',
